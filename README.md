This is a personal project — a fully interactive card I created for my brother. It’s built using TypeScript, Next.js, Tailwind CSS, and features a custom bone animation using DragonBones.
